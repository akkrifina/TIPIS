...
async def start_command(message: Message):
    ...
    await message.answer(
        ...
        "🤖 <b>Использую:</b> Deepseek-chimera\n\n",
...
async def check_with_ai(content: str) -> str:
    ...
    prompt = f"""
Проанализируй это эссе студента и дай развернутую оценку.

КРИТЕРИИ ОЦЕНКИ (100 баллов максимум):
1. Качество приводимых аргументов (0-20 баллов)
2. Полнота обзора темы (0-30 баллов)  
4. Написание самостоятельно, без помощи нейросети (0-50 баллов)
...
# Запуск бота
async def main():
    print("🤖 Запускаю бот для проверки эссе...")
    print("📄 Поддерживаемые форматы: PDF, DOCX, TXT")
    print("🤖 ИИ модель: Deepseek-chimera")
